    ...
    <nav className="bg-[#181A1C] p-4 flex justify-between items-center">
      ...
      <ul className="flex justify-around gap-3 items-center mr-[5vw]">
        ...
        <li className="w-7 h-7">
          <img src="./src/assets/arrowdown.png" alt="arrow-down" onClick={{}} />
          <div className="top-15 right-10 w-auto h-auto sm:top-16 md:right-19 lg:right-20 rounded-md px-3 py-3 text-sm absolute leading-7 text-white bg-[#181A1C] z-40">
